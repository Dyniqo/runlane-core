...
const NON_RETRYABLE_EXECUTION_ERROR_CODES = new Set<string>([
  ...
  'HTTP_CONNECTOR_AUTHENTICATION_INVALID',
  'HTTP_CONNECTOR_CONFIG_INVALID',
  'HTTP_CONNECTOR_REDIRECT_LIMIT_EXCEEDED',
  'HTTP_CONNECTOR_RESPONSE_TOO_LARGE',
  'HTTP_CONNECTOR_STATUS_NOT_ACCEPTED',
  'HTTP_CONNECTOR_URL_BLOCKED',
  'AI_DECISION_BRANCH_INVALID',
  'AI_DECISION_STEP_CONFIG_INVALID',
