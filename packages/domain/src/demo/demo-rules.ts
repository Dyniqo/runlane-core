...
export const DEMO_WORKFLOW_PUBLIC_IDS = {
  ...
  apiEnrichment: 'wf_00000000000000000000000000000042',
  retryFailureDrill: 'wf_00000000000000000000000000000043',
  subscriptionSync: 'wf_00000000000000000000000000000044',
  aiDecisionRouting: 'wf_00000000000000000000000000000045',
} as const;
