...
const LOCAL_DEFAULTS = {
  ...
  STRIPE_CHECKOUT_SUCCESS_URL: 'http://localhost:4610/billing/success',
  STRIPE_CHECKOUT_CANCEL_URL: 'http://localhost:4610/billing/cancel',
  STRIPE_PORTAL_RETURN_URL: 'http://localhost:4610/billing',
  DEMO_MODE: true,
